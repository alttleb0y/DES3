...
//   0x6 : key3_lo    [31:0]   (W)
//   0x7 : key3_hi    [63:32]  (W)
//   0x8 : control    [0]      (W) — ghi 1 để pulse valid_in 1 cycle
//   0x9 : odata_lo   [31:0]   (R)
//   0xA : odata_hi   [63:32]  (R)
//   0xB : status     [0]      (R) — valid_out
...
module des3_avalon #(
    ...
    always @(posedge clk or posedge reset) begin
        if (reset) begin
            ...
            reg_valid_in <= 1'b0; // default pulse = 0
    ...
    always @(*) begin
        case (avs_address)
            4'h9:    avs_readdata = odata[31:0];
            4'hA:    avs_readdata = odata[63:32];
            4'hB:    avs_readdata = {31'b0, valid_out};
